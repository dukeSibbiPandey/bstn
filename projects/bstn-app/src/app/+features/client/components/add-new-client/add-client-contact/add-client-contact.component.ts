...
export class AddClientContactComponent implements OnInit {
  ...
  // @Output() displayPosition2 = new EventEmitter<string>();
  contactTypelst: any;
  statelst: any;

  constructor(private _formBuilder: FormBuilder, private _httpService: HttpService, public _MessageService: MessageService,
