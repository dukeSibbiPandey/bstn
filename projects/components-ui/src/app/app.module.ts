...
import { CustomerService } from './components/controls/client-table/customerservice';
...
import { ClientTableComponent } from './components/controls/client-table/client-table.component';
